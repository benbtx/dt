...
///foothold/getTimePeriodOptions 时段选项

export function getSdxx(query) {
    return axios({
        url: "/foothold/getTimePeriodOptions",
        method: "get",
        params: query
    });
}
...
////foothold/timeLine 落脚点时间轴
export function getTimeLine(data) {
    return axios({
        url: "/foothold/timeLine",
        method: "post",
        data: data
    });
}

//foothold/positionForMap 落脚点位置
export function getPosition(data) {
    return axios({
        url: "/foothold/positionForMap",
        method: "post",
        data: data
    });
}

///foothold/statistics 落脚点统计
export function getLJDStatistics(data) {
    return axios({
        url: "/foothold/statistics",
        method: "post",
        data: data
    });
}

//foothold/DetialForMap 明细查询-地图
export function getDetialForMap(data) {
    return axios({
        url: "/foothold/DetialForMap",
        method: "post",
        data: data
    });
}

//foothold/DetialForStatistics 明细查询-统计
export function getDetialForStatistics(data) {
    return axios({
        url: "/foothold/DetialForStatistics",
        method: "post",
        data: data
    });
}
...
/// /spatiotemporalAnalysis/generateIntervalForMouth 按月生成时间段--存在数据
export function getNyInfo(data) {
    return axios({
        url: "/spatiotemporalAnalysis/generateIntervalForMouth",
        method: "post",
        data: data
    });
}
