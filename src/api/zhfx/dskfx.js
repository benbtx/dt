...
//spatiotemporalAnalysis/DetialForStatistics 特殊时刻分析-统计列表-明细查询
export function getDetialForSpecialMoment(data) {
    return axios({
        url: "/spatiotemporalAnalysis/DetialForStatistics",
        method: "post",
        data: data
    });
}

//spatiotemporalAnalysis/specialMomentStatistics 特殊时刻分析-统计列表
export function getSpecialMomentStatistics(data) {
    return axios({
        url: "/spatiotemporalAnalysis/specialMomentStatistics",
        method: "post",
        data: data
    });
}
