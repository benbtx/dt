        ...
        <div class="basicInfoContainer">
            <div class="basicInfo">
                ...
                <dir class="basicInfo_right">
                    <div
                        v-if="nodeInfo.nodeType == '00'"
                        class="basicInfo_right_first"
                    >
                    ...
                    <div
                        v-if="nodeInfo.nodeType == '01'"
                        class="basicInfo_right_second"
                    >
                    ...
                    <el-button class="detail_button" size="mini"
                        >档案详情</el-button
                    >
                </dir>
            </div>
    ...
    data() {
        return {
            nodedetail: {
                ...
                position: "前端开发",
                labelList: [
                    { name: "标签1", color: "success" },
                    { name: "标签2", color: "primary" },
                    { name: "标签3", color: "danger" },
                    { name: "标签4", color: "primary" },
                    { name: "标签5", color: "primary" }
                ]
            }
        };
    },
