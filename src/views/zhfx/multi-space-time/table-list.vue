...
export default {
    ...
    methods: {
        ...
        getTSSKTJ_detail() {
            this.query = {
                // dabh: this.data.list.dabh || "84646445c6fe11ea82f0",
                dabh: this.$route.query.dabh,
                isMultipleCases: this.$route.query.isMultipleCases,
                dwbm: this.$route.query.dwbm,
                date: this.data.list.date || "2020-05-13",
                idCard: this.data.list.idCard || "792892196811231931",
                // lx: this.data.list.wdselectList.toString(),
                lx: this.data.lx_nc[this.type],
                // ...this.data.list,
    ...
    created() {
        this.data.list;
        this.data.list.wdselectList;
        this.getTSSKTJ_detail();
    },
    mounted() {
        // var _this = this;
